          ...
          <div className="flex gap-2 overflow-x-auto scrollbar-hide pb-1">
            {paymentMethods.map((method) => (
              ...
              >
                ...
                >
                  <div className="w-10 h-10 flex items-center justify-center text-xs font-roboto-bold text-zinc-600 mx-auto">
                    {method.icon}
                  </div>
                  {selectedMethod === method.id && (
              ...
              >
                ...
                >
                  <div className={cn(
                    ...
                    <span className={cn("text-lg font-roboto-bold", bank.color)}>
                      {bank.name.charAt(0)}
                    </span>
                  </div>
                  {selectedBank === bank.id && (
