...
// Crypto methods
const cryptoMethods = [
  { id: "fpay", name: "Fpay", icon: "FPay", color: "bg-emerald-500" },
];

// Payment types (crypto currencies)
const paymentTypes = [
  { id: "fpayusdt", name: "FPay USDT", icon: "USDT", color: "bg-emerald-500" },
];
...
export default function CryptoPage() {
  ...
  const [selectedPaymentType, setSelectedPaymentType] = useState("fpayusdt");
      ...
      <main className="flex-1 overflow-auto px-4 py-4">
          ...
          <div className="flex gap-3">
            {cryptoMethods.map((method) => (
              ...
              >
                <div
                  className={cn(
                    "w-16 h-16 rounded-lg flex items-center justify-center border-2 transition-all relative",
                    method.color,
        ...
        <div className="bg-zinc-50 border border-zinc-200 rounded-lg p-4 mb-4">
          ...
          <div className="space-y-1 text-sm text-zinc-500">
            ...
            <p>Option: FPayUSDT</p>
            <p>Mode: Online</p>
            <p>Min/Max Limit: MYR 20.00 / 5,000.00</p>
            <p>Daily Limit Balance: Unlimited</p>
            <p>Total AllowedTotal Allowed: Unlimited</p>
          </div>
